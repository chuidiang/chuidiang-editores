        ...
        implements InterfaceAceptarCancelarEdicion<Tipo>
{
   ...
   public void setComponenteInterno( InterfaceEdicionDatos<Tipo> panelEditor )
   {
      ...
      // Si ya hay un componente se elimina
      if( componenteInterno != null )
      {
         getContentPane(  )
            .remove( (Component)componenteInterno );
      }
      ...
      getContentPane(  )
         ...
         this.dameGridBagConstraintsEditorInterno(  ) );
   }
   ...
   protected void inicializar(  )
   {
      ...
      getContentPane(  )
         .add( 
         JBuAceptar,
         dameGridBagConstraintsAceptar(  ) );
      getContentPane(  )
         .add( 
         JBuCancelar,
         dameGridBagConstraintsCancelar(  ) );
