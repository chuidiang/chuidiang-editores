 ...
 * Se puede modificar la forma de ocnvertir de Object a String y viceversa, asi
 * como las restricciones que tiene que cumplir el Object para ser valido (estar
 * dentro de un rango, ser fecha festiva, numero primo, etc)
 */
public class Editor<Tipo> extends JFormattedTextField implements
        InterfaceEdicionDatos<Tipo>, InterfaceContenedorConversor<Tipo>,
     ...
     * 
     * @param conversor
     *            New value of property conversor.
     */
    ...
    public void setDato(Tipo valor) {
        ...
        if (restriccion != null) {
            if (restriccion.pasaRestriccion(valor, null) == false) {
                return;
            }
        }
     ...
     * LLama al m�todo validaDato() y si este devuelve false, devuelve el String
     * del JTextField convertido a Object. Si hay alg�n problema en la
     ...
     * 
     * @param restriccion
     *            New value of property restriccion.
     */
     ...
     * 
     * @param tratamientoError
     *            New value of property tratamientoError.
     */
    public void setTratamientoError(
            InterfaceTratamientoError<Tipo> tratamientoError) {
     ...
     * 
     * @param editable
     *            true si se desea que sea editable.<br>
     */
    ...
    /**
     * Lee el contenido del JTextField y devuelve true si dicho contenido es
     * correcto.<br>
     ...
     * 
     * @param error
     *            Devuelve un texto con el error si se produce.<br>
     * 
    ...
    public boolean validaDato(StringBuffer error) {
        ...
        if (conversor != null) {
            try {
                valor = conversor.parseString(cadena);
            } catch (Exception e) {
                valorCorrecto = null;
        ...
        if (restriccion != null) {
            if (restriccion.pasaRestriccion(valor, error) == true) {
                valorCorrecto = valor;
            } else {
                valorCorrecto = null;
    ...
    /**
     * Anade al editor los listeners para comprobar el valor cuando se pulsa
    ...
    private void ponListeners() {
        ...
        this.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (getInputVerifier().shouldYieldFocus(
        ...
        setTratamientoError(new ErrorConColor(Color.WHITE, Color.RED));
    }
}
