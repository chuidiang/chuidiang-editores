        ...
        implements InterfaceConversorString<Number>
{
           ...
           throws ParseException
   {
      ...
      catch( Exception e )
      {
         ...
         throw new ParseException( cadena + "no se puede convertir a " +
            nombreEje,0 );
      }
      ...
      {
         throw new ParseException( cadenaHemisferio +
            " no se puede interpretar como " + this.getCadenaEjePositivo(  ) +
            " o " + this.getCadenaEjePositivo(  ),0 );
      }

      return new Double( 
         GradosConDecimales.getGradosConDecimales( 
            grados,
            minutos,
            segundos,
            signo ) );
